...
class IMS:
    def __init__(self, root):
        ...
        lbl_footer=Label(self.root, text="IMS-SmartShelf Inventory Management | Developed by Vaivashvat\n For any Technical Issuen Contact: 76520XXXXX", font =("times new roman",12,), bg="#4d636d", fg="white",).pack(side=BOTTOM,fil=X)
