...
class categoryClass:
    def __init__(self, root):
        ...
        lbl_title=Label(self.root,text="Manage Product Category",font=("goudy old style",30),bg="#185a45",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fill=X,padx=10,pady=20)
        ...
        cat_frame.place(x=700,y=100,width=380,height=90)
