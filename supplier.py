...
class supplierClass:
    def __init__(self, root):
        ...
        self.txt_desc.place(x=160,y=200,width=470,height=120)
        ...
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("goudy old style",15),bg="#607dab",fg="white",cursor="hand2").place(x=540,y=370,width=110,height=35)
