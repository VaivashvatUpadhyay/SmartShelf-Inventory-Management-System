...
class employeeClass:
    def __init__(self, root):
        ...
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("goudy old style",15),bg="#607dab",fg="white",cursor="hand2").place(x=860,y=305,width=110,height=28)
